...
if ( ! empty( $zerif_bottomribbon_text ) ) :
	...
	echo '<div class="color-overlay">';
		...
		echo '<h3 class="container text" data-scrollreveal="enter left after 0.15s over 1s">'; /*enter left after 0s over 1s*/
	...
	if ( ! empty( $zerif_bottomribbon_buttonlabel ) && ! empty( $zerif_bottomribbon_buttonlink ) ) :
		...
		echo '<div data-scrollreveal="enter left after 0.15s over 1s">'; /*enter right after 0s over 1s*/
	...
	elseif ( is_customize_preview() ) :
		...
		echo '<section class="separator-one zerif_hidden_if_not_customizer" id="ribbon_bottom">';
			...
			echo '<div class="color-overlay">';
				...
				echo '<h3 class="container text" data-scrollreveal="enter left after 0.15s over 1s"></h3>'; /*enter left after 0s over 1s*/

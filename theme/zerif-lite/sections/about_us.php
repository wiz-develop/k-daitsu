...
?>
	...
	<div class="container">
		...
		if ( ! empty( $zerif_aboutus_biglefttitle ) ) :
			...
			echo '<div class="big-intro" data-scrollreveal="enter left after 0.15s over 1s">'; /*enter left after 0s over 1s*/
		...
		if ( ! empty( $zerif_aboutus_text ) ) :
			...
			echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' column zerif_about_us_center ' . $text_and_skills . '" data-scrollreveal="enter left after 0.15s over 1s">'; /*enter bottom after 0s over 1s*/
...
<ul class="skills" data-scrollreveal="enter left after 0.15s over 1s"><!--enter right after 0s over 1s-->
...
<!-- SKILL FOUR -->
	...
	if ( is_active_sidebar( 'sidebar-aboutus' ) ) :
		...
		if ( ! empty( $zerif_aboutus_clients_title_text ) ) {
			...
			echo '<div data-scrollreveal="enter left after 0.15s over 1s">'; /*enter right move 60px after 0.00s over 2.5s*/

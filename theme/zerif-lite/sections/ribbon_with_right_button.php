...
if ( ! empty( $zerif_ribbonright_text ) ) {
	...
	echo '<div class="col-md-9" data-scrollreveal="enter left after 0.15s over 1s">'; /*enter left after 0s over 1s*/
	...
	if ( ! empty( $zerif_ribbonright_buttonlabel ) && ! empty( $zerif_ribbonright_buttonlink ) ) {
		...
		echo '<div class="col-md-3" data-scrollreveal="enter left after 0.15s over 1s">'; /*enter right after 0s over 1s*/

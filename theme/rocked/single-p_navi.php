...
<head>
    <meta charset="utf-8" />
    <script type="text/javascript" src="/cms/wp-content/themes/rocked/js/tiny_segmenter-0.2.js"></script>
    ...
    ; (function ($) {
        $(function(){
            ...
            $("h1, h2, h3, h4, p").each(function() {
                if ($(this).text() && !$(this).has('a').length) {
                    var spans = [];
                    ...
                    $(this).html("<span style='display: inline-block'>" + spans.join("</span><span style='display: inline-block'>") + "</span>");
                }
            });
        });
    })(jQuery);;
